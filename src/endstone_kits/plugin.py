...
class KitsPlugin(Plugin):
    ...
    commands = {
        "kit": {
            ...
            "usages": [
                ...
                "/kit addcommand <id: string> <command: message>",
    ...
    def _init_managers(self) -> None:
        ...
        self._permission_manager = PermissionManager(NativePermissionProvider())
        self._command_execution_manager = CommandExecutionManager()
