...
class KitMetadata:
    ...
    # Kit sekali pakai per player: sekali diklaim, TIDAK BISA diklaim
    # lagi selama-lamanya oleh player yang sama, terlepas dari
    # `cooldown_seconds` (yang jadi tidak relevan kalau ini True).
    # Diperiksa via `CooldownManager.has_ever_claimed()`, memakai ulang
    # data cooldown yang sudah ada -- tidak perlu skema penyimpanan
    # baru (lihat dokumen desain §5 & catatan di `cooldown_manager.py`).
    one_time: bool = False
